...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar ItemsArray = [{\n  index: 0,\n  description: 'Go grocery shopping',\n  completed: false\n}, {\n  index: 1,\n  description: 'Walk the dog',\n  completed: false\n}, {\n  index: 2,\n  description: 'Do laundry',\n  completed: false\n}, {\n  index: 3,\n  description: 'Do teh dishes',\n  completed: false\n}, {\n  index: 4,\n  description: 'Call mom',\n  completed: false\n}];\nvar insideItem = '';\nItemsArray.forEach(function (singleItemContents) {\n  insideItem += \"\\n      <li class=\\\"item\\\">\\n          <input value=\\\"\".concat(singleItemContents.index, \"\\\" name=\\\"item\\\" type=\\\"checkbox\\\" data-index=\\\"\").concat(singleItemContents.index, \"\\\" id=\\\"\").concat(singleItemContents.index, \"\\\">\\n          <label for=\\\"0\").concat(singleItemContents.index, \"\\\">\").concat(singleItemContents.description, \"</label>\\n          <button type=\\\"button\\\" class=\\\"btn\\\"></button>\\n      </li>\\n      \");\n});\nvar section = document.querySelector('.list');\nsection.innerHTML = insideItem;\nvar checkboxes = document.querySelectorAll(\"input[type='checkbox']\");\ncheckboxes.forEach(function (checkbox) {\n  checkbox.addEventListener('change', function (event) {\n    var index = parseInt(event.target.value, 10);\n    var task = ItemsArray.find(function (task) {\n      return task.index === index;\n    });\n    if (event.target.checked) {\n      task.completed = true;\n    } else {\n      task.completed = false;\n    }\n  });\n});\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (section);\n\n//# sourceURL=webpack://todolistapp/./src/modules/items.js?");
